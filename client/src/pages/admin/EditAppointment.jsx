...
function EditAppointment() {
    const {doctors,  updateAppointmentHandler,editAppointment}  = useContext(HospitalContext)
    ...
    const submitHandler = (e)=>{
        ...
        updateAppointmentHandler(editAppointment.items.item.id, editappointment)
