...
function EditPatient() {
  const {updatePatientHandler, editPatient} = useContext(HospitalContext)
  ...
  const submitHandler = (e)=>{
    ...
    updatePatientHandler(editPatient.items.item.id, newPatient)
            ...
            <form action="" onSubmit={submitHandler} className='space-y-8'>
                ...
                <div className="lg:flex justify-between mx-4">
                    <div class="lg:w-[48%]">
                        ...
                        <input type="password" id="password" value={password} onChange={(e)=>{setPassword(e.target.value)}} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  placeholder-[#007CFF] dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Input Password" required />
                    </div> 
                    <div class="lg:w-[48%]">
