...
function Home() {
  return (
    <div className='bg-[#d4ebfe] flex flex-col lg:flex-row  w-full h-screen'>
      {/* setion 1 */}
        <section className=' lg:w-[80%]'>
          {/* vital boxes */}
          <div className="flex flex-col lg:flex-row gap-3 m-5 boxes">
            <div className="box-1 rounded-md h-[150px] md:w-[250px] w-[150px] md:h-[250px] text-[#001D4E] bg-[#B9D9EB]  ">
            ...
            <div className="box-2 rounded-md h-[150px] md:w-[250px] w-[150px] md:h-[250px] text-[#B9D9EB] bg-[#001D4E] ">
            ...
            <div className="box-3 h-[150px] md:w-[250px] rounded-md w-[150px] md:h-[250px] text-[#001D4E] bg-[#B9D9EB] ">
                <div className="mx-12 md:mx-20 mt-6 icon">
